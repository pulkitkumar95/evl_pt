...
class SelfMotionModule(nn.Module):
    ...
    def forward(self, point_trajs_gt_coord, point_trajs_visibility_mask, point_trajs_gt_rgbtoken_index, temporal_pos_embed):
        ...
        cat_feas = torch.concat((selfmotion_feas, absolute_pos_embd_out),dim=-1) # (B, T, M, D3=256)
...
class EVLDecoderSelfmotion(nn.Module):
    ...
    def __init__(
        ...
        self.motion_model = SelfMotionModule(in_feature_dim=14*14*2, fea_dim_absolute = 384, fea_dim_selfmotion=384)
...
class EVLTransformerSelfmotion(nn.Module):
    ...
    def __init__(
        ...
        self.decoder = EVLDecoderSelfmotion(
        ...
        print('verbose...EVLTransformerSelfmotion')
...
if __name__ == "__main__":
    ...
    model = SelfMotionModule(in_feature_dim=M*2, fea_dim_absolute = 384, fea_dim_selfmotion=384)
